...
function token(name: string) {
  // LOCAL PATCH (see LOCAL.md): the tokens are remapped to RGB triplets in
  // `src/theme/agent-prism.css` so they can be drawn from the Phoenix palette.
  return `rgb(var(--${agentPrismPrefix}-${name}) / <alpha-value>)`;
}
