...
/** Base icon — 24px viewBox, 2px stroke, inherits `currentColor`, 16px default. */
...
export const IconTrace = (p: { size?: number }) => (
  <Icon {...p}>
...
export const IconCoins = (p: { size?: number }) => (
  <Icon {...p}>
...
export const IconAlertTriangle = (p: { size?: number }) => (
  <Icon {...p}>
...
export const IconCheckCircle = (p: { size?: number }) => (
  <Icon {...p}>
    <circle cx="12" cy="12" r="10" />
...
export const IconPanelLeft = (p: { size?: number }) => (
  <Icon {...p}>
...
export const IconDatabase = (p: { size?: number }) => (
  <Icon {...p}>
